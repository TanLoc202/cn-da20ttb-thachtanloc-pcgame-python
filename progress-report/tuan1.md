...
- Thời gian: từ ngày 10/11/2025 đến ngày 16/11/2025

## Kế hoạch thực hiện - Tuần 1 đã nếu trong đề cương chi tiết

- Nghiên cứu tổng quan về phát triển trò chơi và thư viện pygame.
- Lập kịch bản chi tiết cho ý tưởng trò chơi thoát hiểm - tìm đường thoát khỏi căn phòng).
- Cài đặt môi trường (Python, Pygame, VS Code).
- Thiết lập cửa sổ hiện thị, tiêu đề và kích thước.
- Viết báo cáo.
